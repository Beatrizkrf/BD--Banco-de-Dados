...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Set-2025 às 17:34
...
(1, 'Fiat Uno', 'Compacto econômico, ótimo para uso urbano.'),
(2, 'Chevrolet Onix', 'Hatch moderno, confortável e com bom consumo de combustível.'),
(3, 'Honda Civic', 'Sedã confiável, espaçoso e com ótimo desempenho.'),
(4, 'Toyota Corolla', 'Sedã médio com tecnologia avançada e muito conforto.'),
(5, 'FIAT SIENA', 'Sedã compacto da Fiat, ideal para famílias.'),
(6, 'Ford Ka', 'Carro pequeno, prático e fácil de estacionar.'),
(7, 'Renault Sandero', 'Hatch robusto, com bom espaço interno e custo-benefício.'),
(8, 'Jeep Compass', 'SUV com bom desempenho, ideal para viagens longas.'),
(9, 'Hyundai HB20', 'Compacto moderno, muito popular no Brasil.'),
(10, 'Nissan Kicks', 'SUV estiloso, com tecnologia e bom espaço interno.');
...
(2, 'XYZ9K87', 'Preto', 2, 1, 2020),
(3, 'MNO5T43', 'Branco', 3, 5, 2015),
(4, 'QWE8R65', 'Vermelho', 4, 2, 1988),
(5, 'JKL7H21', 'Azul', 5, 4, 1999),
(6, 'POI4L98', 'Cinza', 6, 6, 2025),
(7, 'UYT2R11', 'Verde', 7, 7, 2011),
(8, 'GHJ6Y77', 'Amarelo', 8, 8, 2009),
(9, 'BNM3Q54', 'Rosa', 9, 9, 2005),
(10, 'TRE1P09', 'lilas', 10, 10, 2002);
